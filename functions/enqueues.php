...
//
//    /* Font Awesome */
//    wp_register_style('fontawesome', get_lispra_lib_path().'vendors/font-awesome/css/font-awesome.min.css', false, null);
//    wp_enqueue_style('fontawesome');
//
//    /* PNotify */
//    wp_register_style('pnotify', get_lispra_lib_path().'vendors/pnotify/dist/pnotify.css', false, null);
//    wp_enqueue_style('pnotify');
//    wp_register_style('pnotify-buttons', get_lispra_lib_path().'vendors/pnotify/dist/pnotify.buttons.css', false, null);
//    wp_enqueue_style('pnotify-buttons');
//    wp_register_style('pnotify-nonblock', get_lispra_lib_path().'vendors/pnotify/dist/pnotify.nonblock.css', false, null);
...
//   
//    /* PNotify */
//    wp_register_script('pnotify-js', get_lispra_lib_path().'vendors/pnotify/dist/pnotify.js', false, null, true);
//    wp_enqueue_script('pnotify-js');
//    wp_register_script('pnotify-buttons-js', get_lispra_lib_path().'vendors/pnotify/dist/pnotify.buttons.js', false, null, true);
//    wp_enqueue_script('pnotify-buttons-js');
//    wp_register_script('pnotify-nonblock-js', get_lispra_lib_path().'vendors/pnotify/dist/pnotify.nonblock.js', false, null, true);
//    wp_enqueue_script('pnotify-nonblock-js');
//    
//    /* Lispra */
//    wp_register_script('lispra-js', get_lispra_lib_path().'js/lispra.js', false, null, true);
//    wp_enqueue_script('lispra-js');
//    get_lispra_lib_directory_uri
